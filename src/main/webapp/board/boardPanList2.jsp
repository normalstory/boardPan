			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="row">
					<div class="col-sm-8 blog-main">
						...
						<a class="btn btn-default pull-right" href="/userForm">새글 등록</a>

						<div class="text-center">
							<ul class="pagination">
								<li><a href="/userPageList?page=1&pageSize=10" aria-label="Previous"> 
								...
								<li><a href="/userPageList?page=${pageNum }&pageSize=10" aria-label="Next"> 
